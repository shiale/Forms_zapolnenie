...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	Если ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.СчетНаОплатуПокупателю") Тогда
		...
		ЗаполнитьЗначенияСвойств(ЭтотОбъект,ДанныеЗаполнения,"Организация, Контрагент, Договор, Менеджер, Склад, СуммаДокумента");
		Для Каждого СтрокаТоварыОснование Из ДанныеЗаполнения.Товары Цикл
			Строка = Товары.Добавить();
			ЗаполнитьЗначенияСвойств(Строка,СтрокаТоварыОснование);
		КонецЦикла;
		
		Для Каждого УслугаОснование Из ДанныеЗаполнения.Услуги Цикл
			Строка = Услуги.Добавить();
			ЗаполнитьЗначенияСвойств(Строка,УслугаОснование);
		КонецЦикла;
